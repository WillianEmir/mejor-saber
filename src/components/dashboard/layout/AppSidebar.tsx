...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Material de Esudio",
    path: '/dashboard/material-estudio'
  },
  {
    icon: <RocketLaunchIcon className="size-5.5" />,
    name: "Mi Progreso",
    path: '/dashboard/mi-progreso'
  },
  {
    icon: <HandRaisedIcon className="size-5.5" />,
    name: "Ejercicios de Práctica",
    path: '/dashboard/ejercicios-practica'
  }
];

const othersItems: NavItem[] = [
  {
    icon: <Squares2X2Icon className="size-5.5" />,
    name: "Charts",
    subItems: [
...
const AppSidebar: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className={`${!isMobileOpen ? 'py-8' : 'pt-3' }  flex  ${!isExpanded && !isHovered ? "lg:justify-center" : "justify-start"}`}
      >
        <Link href="/">
          {isExpanded || isHovered || !isMobileOpen ? (
            <>
