...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var badgesToCreate, _i, badgesToCreate_1, badgeData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _i = 0, badgesToCreate_1 = badgesToCreate;
                    _a.label = 1;
                case 1:
                    if (!(_i < badgesToCreate_1.length)) return [3 /*break*/, 4];
                    badgeData = badgesToCreate_1[_i];
                ...
                case 2:
                    _a.sent();
                    console.log("Upserted badge: ".concat(badgeData.name));
                    _a.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
