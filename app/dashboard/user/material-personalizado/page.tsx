...
import { getMaterialPersonalizadoByUserId } from '@/src/lib/data/areas.data';

import MaterialRepaso from '../material-repaso/_components/MaterialRepaso';

export default async function MaterialPersonalizadoPage() {
