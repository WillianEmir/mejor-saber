...
import { EvidenciaProgressType, areaAveragesType, CompetenciaProgressType } from '../_lib/schoolProgress.schema';
...
export default function SchoolEvidenciaProgress({ evidenciaProgress, areaAverages, competenciaProgress }: SchoolEvidenciaProgressProps) {
