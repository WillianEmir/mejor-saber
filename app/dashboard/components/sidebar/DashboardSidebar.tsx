...
const DashboardSidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col overflow-y-scroll duration-300 ease-linear pt-2">
        {navConfig.map((nav) => (
      ...
      <div className="py-1 border-t max-lg:mb-15 border-gray-300 dark:border-neutral-light/30">
        <Link href="/dashboard/profile">
          <div className="flex items-center gap-4 p-1 rounded-md hover:bg-primary/10 transition-all duration-200 dark:hover:bg-neutral-dark">
            <Image
              src={data?.user.avatar || "/images/default-avatar.png"} //TODO: Add default user avatar
              alt="User avatar"
              width={50}
              height={50}
