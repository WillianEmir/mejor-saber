...
export default function SchoolProgressChart({ chartData }: SchoolProgressChartProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-center">Progreso General de la Escuela</CardTitle>
      </CardHeader>
